...
namespace Netotik.ViewModels.Identity.UserReseller
{
    public class ProfileModel
    {
        ...
        [Display(Name = "کد ملی")]
        [System.Web.Mvc.Remote("CheckNationalCode", "Remote", System.Web.Mvc.AreaReference.UseRoot, AdditionalFields = "Id", HttpMethod = "POST", ErrorMessage = "کد ملی اشتباه است یا قبلا در سیستم ثبت شده است.")]
