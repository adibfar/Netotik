...
namespace Netotik.ViewModels.Identity.UserReseller
{
    public class RegisterViewModel
    {
        ...
        [Display(Name = "کد ملی")]
        [System.Web.Mvc.Remote("CheckNationalCode", "Remote", System.Web.Mvc.AreaReference.UseRoot, AdditionalFields = "Id", HttpMethod = "POST", ErrorMessage = "این کد ملی قبلا ثبت شده است.")]
