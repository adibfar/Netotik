...
namespace Netotik.Web.Areas.Admin.Controllers
{
    public partial class ResourceController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ResourceController Actions { get { return MVC.Admin.Resource; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Resource";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Resource";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/Resource/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ResourceController : Netotik.Web.Areas.Admin.Controllers.ResourceController
    {
