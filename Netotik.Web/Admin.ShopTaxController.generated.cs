...
{
    public partial class ShopTaxController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShopTaxController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShopTaxController Actions { get { return MVC.Admin.ShopTax; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShopTax";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShopTax";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ShopTax/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ShopTax/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ShopTax/CreateOrEdit.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ShopTax/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ShopTax/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShopTaxController : Netotik.Web.Areas.Admin.Controllers.ShopTaxController
    {
        public T4MVC_ShopTaxController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.Tax.TaxModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.Shop.Tax.TaxModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.Tax.TaxModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.Shop.Tax.TaxModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
