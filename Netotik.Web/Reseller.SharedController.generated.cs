...
namespace T4MVC.Reseller
{
    public class SharedController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Attachments = "~/Areas/Reseller/Views/Shared/_Attachments.cshtml";
            public readonly string _BreadCrumb = "~/Areas/Reseller/Views/Shared/_BreadCrumb.cshtml";
            public readonly string _CaptchaPartial = "~/Areas/Reseller/Views/Shared/_CaptchaPartial.cshtml";
            public readonly string _CaptchaPartial2 = "~/Areas/Reseller/Views/Shared/_CaptchaPartial2.cshtml";
            public readonly string _Head = "~/Areas/Reseller/Views/Shared/_Head.cshtml";
            public readonly string _HeadMenu = "~/Areas/Reseller/Views/Shared/_HeadMenu.cshtml";
            public readonly string _Layout = "~/Areas/Reseller/Views/Shared/_Layout.cshtml";
            public readonly string _MessageResult = "~/Areas/Reseller/Views/Shared/_MessageResult.cshtml";
            public readonly string _PicturesList = "~/Areas/Reseller/Views/Shared/_PicturesList.cshtml";
            public readonly string _SideBarAdminMenu = "~/Areas/Reseller/Views/Shared/_SideBarAdminMenu.cshtml";
            public readonly string _SideBarMenu = "~/Areas/Reseller/Views/Shared/_SideBarMenu.cshtml";
            public readonly string _SingleImageForm = "~/Areas/Reseller/Views/Shared/_SingleImageForm.cshtml";
            public readonly string Error = "~/Areas/Reseller/Views/Shared/Error.cshtml";
