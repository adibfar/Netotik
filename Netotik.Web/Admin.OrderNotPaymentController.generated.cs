...
{
    public partial class OrderNotPaymentController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected OrderNotPaymentController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderNotPaymentController Actions { get { return MVC.Admin.OrderNotPayment; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "OrderNotPayment";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "OrderNotPayment";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/OrderNotPayment/_Table.cshtml";
            public readonly string Detail = "~/Areas/Admin/Views/OrderNotPayment/Detail.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/OrderNotPayment/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrderNotPaymentController : Netotik.Web.Areas.Admin.Controllers.OrderNotPaymentController
    {
        public T4MVC_OrderNotPaymentController() : base(Dummy.Instance) { }
