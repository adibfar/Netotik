...
{
    public partial class ShopDeliveryDateController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShopDeliveryDateController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShopDeliveryDateController Actions { get { return MVC.Admin.ShopDeliveryDate; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShopDeliveryDate";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShopDeliveryDate";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ShopDeliveryDate/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ShopDeliveryDate/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ShopDeliveryDate/CreateOrEdit.cshtml";
            public readonly string Detail = "~/Areas/Admin/Views/ShopDeliveryDate/Detail.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ShopDeliveryDate/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ShopDeliveryDate/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShopDeliveryDateController : Netotik.Web.Areas.Admin.Controllers.ShopDeliveryDateController
    {
        public T4MVC_ShopDeliveryDateController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.DeliveryDate.DeliveryDateModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.Shop.DeliveryDate.DeliveryDateModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.DeliveryDate.DeliveryDateModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.Shop.DeliveryDate.DeliveryDateModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
