...
namespace Netotik.Web.Areas.MyRouter.Controllers
{
    public partial class UserManagerController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult GetUserLogRequest()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetUserLogRequest);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UserManagerController Actions { get { return MVC.MyRouter.UserManager; } }
        ...
        static readonly ActionParamsClass_GetUserLogRequest s_params_GetUserLogRequest = new ActionParamsClass_GetUserLogRequest();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetUserLogRequest GetUserLogRequestParams { get { return s_params_GetUserLogRequest; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetUserLogRequest
        {
            public readonly string Id = "Id";
        }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetUserLog
        {
            public readonly string model = "model";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string UserDetails = "~/Areas/MyRouter/Views/UserManager/UserDetails.cshtml";
            public readonly string UserEdit = "~/Areas/MyRouter/Views/UserManager/UserEdit.cshtml";
            public readonly string UserList = "~/Areas/MyRouter/Views/UserManager/UserList.cshtml";
        }
    }
    ...
    public partial class T4MVC_UserManagerController : Netotik.Web.Areas.MyRouter.Controllers.UserManagerController
    {
        ...
        [NonAction]
        partial void RegisterSettingOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Identity.UserRouter.RegisterSettingModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> RegisterSetting(Netotik.ViewModels.Identity.UserRouter.RegisterSettingModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RegisterSetting);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ClientAreaOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Identity.UserRouter.ProfileModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult ClientArea(Netotik.ViewModels.Identity.UserRouter.ProfileModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ClientArea);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void OnlineOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Online()
        {
