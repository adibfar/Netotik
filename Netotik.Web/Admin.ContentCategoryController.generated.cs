...
{
    public partial class ContentCategoryController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ContentCategoryController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> IsSubjectNameExist()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.IsSubjectNameExist);
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ContentCategoryController Actions { get { return MVC.Admin.ContentCategory; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ContentCategory";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ContentCategory";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string IsSubjectNameExist = "IsSubjectNameExist";
        ...
        public class ActionNameConstants
        {
            ...
            public const string IsSubjectNameExist = "IsSubjectNameExist";
        ...
        static readonly ActionParamsClass_IsSubjectNameExist s_params_IsSubjectNameExist = new ActionParamsClass_IsSubjectNameExist();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_IsSubjectNameExist IsSubjectNameExistParams { get { return s_params_IsSubjectNameExist; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_IsSubjectNameExist
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ContentCategory/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ContentCategory/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ContentCategory/CreateOrEdit.cshtml";
            public readonly string Detail = "~/Areas/Admin/Views/ContentCategory/Detail.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ContentCategory/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ContentCategory/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContentCategoryController : Netotik.Web.Areas.Admin.Controllers.ContentCategoryController
    {
        public T4MVC_ContentCategoryController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.CMS.ContentCategory.ContentCategoryModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.CMS.ContentCategory.ContentCategoryModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.CMS.ContentCategory.ContentCategoryModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.CMS.ContentCategory.ContentCategoryModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
        ...
        [NonAction]
        partial void IsSubjectNameExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string name, int? id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> IsSubjectNameExist(string name, int? id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.IsSubjectNameExist);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "name", name);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            IsSubjectNameExistOverride(callInfo, name, id);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
