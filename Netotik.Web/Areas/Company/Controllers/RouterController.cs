...
namespace Netotik.Web.Areas.Company.Controllers
{
 ...
 Order = 0, GlyphIcon = "icon icon-table")]
    public partial class RouterController : BaseController
    {
        #region ctor
        ...
        {
            //var logined_user =_applicationUserManager.SingleOrDefault(User.UserId);
            ////-------------------------------
            ...
            //mikrotik.MK(logined_user.R_Host, logined_user.R_Port);
            //if (!mikrotik.Login(logined_user.R_User, logined_user.R_Password)) mikrotik.Close();
            ////-----------------------------------------------
            ...
            //        }
            //        ViewBag.uptime = ColumnList.Any(x => x.Key == "uptime") ? (ColumnList.FirstOrDefault(x => x.Key == "uptime").Value.Replace("d"," ").Replace("h", ":").Replace("m", ":").Replace("s", "")) : "";
        ...
        public virtual ActionResult Info_Update()
        {
            ...
            //}
            ////-------------------------------
            //_mikrotikServices.Router_Info_Update(logined_user.R_Host, logined_user.R_Port, logined_user.R_User, logined_user.R_Password);
            //SetResultMessage(false, MessageColor.Info, "بروزرسانی آغاز شد.لطفا به مدت 2الی5دقیقه منتظر بمانید تا روتر بروزرسانی ها را دریافت و نصب نماید.هنگام نصب نیاز به ریبوت روتر می باشد که به صورت خودکار انجام می شود.", Messages.SettingUpdateSuccess);
        ...
        public virtual ActionResult PPP()
        {
            ...
            //}
            ////-------------------------------
            //ViewBag.model = _mikrotikServices.Interface(logined_user.R_Host, logined_user.R_Port, logined_user.R_User, logined_user.R_Password);
            return View();
        }
        [Mvc5Authorize(Roles = "Company")]
