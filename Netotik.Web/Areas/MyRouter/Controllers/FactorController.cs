    ...
    public partial class FactorController : BasePanelController
    {
        ...
        public virtual ActionResult Result(long Id)
        {
            ...
            if (paymentType == null)
            {
                ...
                return RedirectToAction(MVC.MyRouter.Factor.Index());
            }
            ...
            if (Request.QueryString["Status"] != "" && Request.QueryString["Status"] != null && Request.QueryString["Authority"] != "" && Request.QueryString["Authority"] != null)
            {
                if (Request.QueryString["Status"].ToString().Equals("OK"))
                {
                    ...
                    if (Status == 100)
                    {
                        ...
                        if (factor.FactorType == Domain.Entity.FactorType.RouterBySmsPackage)
                        {
                            factor.User.UserRouter.SmsCharge += factor.FactorSmsDetail.SmsCount;
                        }
                        ...
                        {
                            RouterName = factor.User.FirstName,
                            FactorDate = factor.PaymentDate.Value,
                            FactorId = factor.Id,
                            Price = factor.PaymentPrice,
                            ServiceName = factor.FactorType == Domain.Entity.FactorType.RouterBySmsPackage ? factor.FactorSmsDetail.PackageName : "",
