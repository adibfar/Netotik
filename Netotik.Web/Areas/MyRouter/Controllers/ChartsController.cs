 ...
 Order = 0, GlyphIcon = "icon icon-table")]
    public partial class ChartsController : BasePanelController
    {
        ...
        public virtual ActionResult MaxTrafficUsage()
        {
            ...
            //-------------------------------
            var UsermanagerSessions = _mikrotikServices.Usermanager_GetAllUsersSessions(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
            var UsermanagerUsers = _mikrotikServices.Usermanager_GetAllUsers(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
        ...
        public virtual ActionResult UsermanagerUsage()
        {
            ...
            //-------------------------------
            var UsermanSessions = _mikrotikServices.Usermanager_GetAllUsersSessions(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
            var UsermanUsers = _mikrotikServices.Usermanager_GetAllUsers(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
        ...
        public virtual ActionResult Sessions()
        {
            ...
            //-------------------------------
            var temp = _mikrotikServices.Usermanager_GetAllUsersSessions(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
        ...
        public virtual ActionResult Logs()
        {
            ...
            //-------------------------------
            ViewBag.Model = _mikrotikServices.Usermanager_GetAllLogs(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
            return View();
        }
        ...
        public virtual ActionResult WebSitesLogs()
        {
            ...
            var Users = _mikrotikServices.Usermanager_GetAllUsersSessions(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
        ...
        public virtual JsonResult GetMaxTimeUsage()
        {
            var Sessions = _mikrotikServices.Usermanager_GetAllUsersSessions(UserLogined.UserRouter.R_Host, UserLogined.UserRouter.R_Port, UserLogined.UserRouter.R_User, UserLogined.UserRouter.R_Password);
            var date30 = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day).AddDays(-29);
            var date365 = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day).AddDays(-364);
            var logs30 = Sessions.Where(x => Infrastructure.EnglishConvertDate.ConvertToEn(x.till_time) > date30).ToList();
            var logs365 = Sessions.Where(x => Infrastructure.EnglishConvertDate.ConvertToEn(x.till_time) > date365).ToList();
