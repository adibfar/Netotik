...
namespace Netotik.Web.Areas.Admin.Controllers
{
    public partial class OrderController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/Order/_Table.cshtml";
            public readonly string Detail = "~/Areas/Admin/Views/Order/Detail.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/Order/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrderController : Netotik.Web.Areas.Admin.Controllers.OrderController
    {
        ...
        [NonAction]
        partial void AcceptOrderOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> AcceptOrder(int id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.AcceptOrder);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
