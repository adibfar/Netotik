...
{
    public partial class LuceneIndexingController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected LuceneIndexingController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public LuceneIndexingController Actions { get { return MVC.Admin.LuceneIndexing; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "LuceneIndexing";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "LuceneIndexing";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LuceneIndexingController : Netotik.Web.Areas.Admin.Controllers.LuceneIndexingController
    {
        public T4MVC_LuceneIndexingController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ReIndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult ReIndex()
        {
