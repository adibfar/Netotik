...
{
    public partial class ShopDiscountController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShopDiscountController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShopDiscountController Actions { get { return MVC.Admin.ShopDiscount; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShopDiscount";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShopDiscount";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ShopDiscount/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ShopDiscount/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ShopDiscount/CreateOrEdit.cshtml";
            public readonly string Detail = "~/Areas/Admin/Views/ShopDiscount/Detail.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ShopDiscount/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ShopDiscount/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShopDiscountController : Netotik.Web.Areas.Admin.Controllers.ShopDiscountController
    {
        public T4MVC_ShopDiscountController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.Discount.DiscountModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.Shop.Discount.DiscountModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.Discount.DiscountModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.Shop.Discount.DiscountModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
