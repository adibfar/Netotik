...
{
    public partial class ShopProductAttributeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShopProductAttributeController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> IsCategoryNameExist()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.IsCategoryNameExist);
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShopProductAttributeController Actions { get { return MVC.Admin.ShopProductAttribute; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShopProductAttribute";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShopProductAttribute";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string IsCategoryNameExist = "IsCategoryNameExist";
        ...
        public class ActionNameConstants
        {
            ...
            public const string IsCategoryNameExist = "IsCategoryNameExist";
        ...
        static readonly ActionParamsClass_IsCategoryNameExist s_params_IsCategoryNameExist = new ActionParamsClass_IsCategoryNameExist();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_IsCategoryNameExist IsCategoryNameExistParams { get { return s_params_IsCategoryNameExist; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_IsCategoryNameExist
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ShopProductAttribute/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ShopProductAttribute/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ShopProductAttribute/CreateOrEdit.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ShopProductAttribute/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ShopProductAttribute/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShopProductAttributeController : Netotik.Web.Areas.Admin.Controllers.ShopProductAttributeController
    {
        public T4MVC_ShopProductAttributeController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.ProductAttribute.ProductAttributeModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.Shop.ProductAttribute.ProductAttributeModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.ProductAttribute.ProductAttributeModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.Shop.ProductAttribute.ProductAttributeModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
        ...
        [NonAction]
        partial void IsCategoryNameExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string name, int? id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> IsCategoryNameExist(string name, int? id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.IsCategoryNameExist);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "name", name);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            IsCategoryNameExistOverride(callInfo, name, id);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
