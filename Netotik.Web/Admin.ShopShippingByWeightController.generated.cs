...
{
    public partial class ShopShippingByWeightController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ShopShippingByWeightController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ShopShippingByWeightController Actions { get { return MVC.Admin.ShopShippingByWeight; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ShopShippingByWeight";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ShopShippingByWeight";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Table = "~/Areas/Admin/Views/ShopShippingByWeight/_Table.cshtml";
            public readonly string Create = "~/Areas/Admin/Views/ShopShippingByWeight/Create.cshtml";
            public readonly string CreateOrEdit = "~/Areas/Admin/Views/ShopShippingByWeight/CreateOrEdit.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/ShopShippingByWeight/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/ShopShippingByWeight/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ShopShippingByWeightController : Netotik.Web.Areas.Admin.Controllers.ShopShippingByWeightController
    {
        public T4MVC_ShopShippingByWeightController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.ShippingByWeight.ShippingByWeightModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Netotik.ViewModels.Shop.ShippingByWeight.ShippingByWeightModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Netotik.ViewModels.Shop.ShippingByWeight.ShippingByWeightModel model, Netotik.Common.Controller.ActionType actionType);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Netotik.ViewModels.Shop.ShippingByWeight.ShippingByWeightModel model, Netotik.Common.Controller.ActionType actionType)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "actionType", actionType);
